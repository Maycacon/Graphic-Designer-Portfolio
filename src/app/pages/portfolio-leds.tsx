...
export const ledsProjects = [
  {
    ...
    category: 'Branding',
    description: 'Animação de logo com efeitos dinâmicos',
  ...
  },
  {
    ...
    description: 'Tipografia em movimento sincronizada',
    video: 'https://res.cloudinary.com/da13zwelb/video/upload/v1774042362/atlantisEmpire_v8rnbq.mp4',
  ...
  {
    id: 3,
    title: 'Infográfico Animado',
    category: 'Explainer',
    description: 'Dados complexos em animação clara',
    video: 'https://res.cloudinary.com/da13zwelb/video/upload/v1774042362/atlantisEmpire_v8rnbq.mp4',
  ...
  },
  {
    ...
    description: 'Pack de transições para edição',
  ...
  },
  {
    ...
    title: 'Lower Thirds',
    category: 'Broadcast',
    description: 'Elementos gráficos para vídeo',
  ...
  },
  {
    ...
    description: 'Animação abstrata experimental',
...
export function PortfolioLeds({ onNavigate }: PortfolioLedsProps, p0: number, title: any, p1: string, category: any, p2: string, description: any, p3: string, image: any, p4: string) {
  const [selectedProject, setSelectedProject] = useState<typeof ledsProjects[0] | null>(null);
  return (
